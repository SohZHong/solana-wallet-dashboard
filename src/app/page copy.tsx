...
//   const { data: fetchedTokenData } = fetchTokenDataByIds(tokenIds, currency);

//   useEffect(() => {
//     const settings = localStorage.getItem('currency');
//     setCurrency(settings ? settings : 'usd');
//   }, [])
...
//         console.log('Processing token:', mintAddress, tokenInfo);
      
//         if (!tokenInfo) return null;
      
//         const tokenData = fetchedTokenData?.find((td) => td.id === tokenInfo.id);
        
//         console.log('Fetched token data:', fetchedTokenData);
...
//   }, [publicKey, connection, memoizedTokens, fetchedTokenData, balance, currency]);
